...
import './previewDialogAlong.less';
                        ...
                        <div className="content">
                        	...
                        	<div className="swiper-container">
				                <div className="swiper-wrapper"> 
				                    {
				                        this.props.pages.map((page, index) => <div className="swiper-slide" key={page.id} style={{width:'240px'}}><div><Page page={page} viewing isTeacher={true} /></div></div>)
				                    }
				                </div>
				            </div>
				            </div>
